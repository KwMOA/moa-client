...
public:
    ...
    virtual void cancelCreateBuilding(int userIndex, int objectType) = 0;
    virtual void upgradeBuilding(int userIndex, int objectType, int upgradeType) = 0;
    virtual void cancelUpgradeBuilding(int userIndex, int objectType, int upgradeType) = 0;
