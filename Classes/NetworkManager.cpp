...
bool NetworkManager::initInstance(char* ip, int port) {
    
    if(instance == NULL) {
        instance = new NetworkManager();
        
        return instance->initialize(ip, port);
    }
...
bool NetworkManager::initialize(char* ip, int port)
{
    network = new Network();
    ...
    if (network->connectWithServer(SERVER_MODULE_FRONT_SERVER, ip, port) == false)
    {
        return false;
    }
...
void NetworkManager::Receive(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::frontHandleFirstConnectRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    printf("NetworkManager::frontHandleFirstConnectRes");
...
void NetworkManager::frontHandleLoginRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    printf("NetworkManager::frontHandleLoginRes");
...
void NetworkManager::frontHandleCreateAccountRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    printf("NetworkManager::frontHandleCreateAccountRes");
...
void NetworkManager::frontHandleEnterLobbyRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    printf("NetworkManager::frontHandleEnterLobbyRes");
...
void NetworkManager::lobbyHandleFirstConnectRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::lobbyHandleChannelInfoNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::lobbyHandleFirstConnectOk(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::lobbyHandleFirstConnectOut(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    exit(0);
}

void NetworkManager::lobbyHandleGetChannelListRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::lobbyHandleMoveChannelRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::lobbyHandleGetUserInfoRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleEnterUserInChannelNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::lobbyHandleLeaveUserInChannelNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::lobbyHandleRequestGameRes(ConnectInfo* connectInfo, const char* pData, int pDataSize)
{
    
}


void NetworkManager::lobbyHandleRequestGameNotify(ConnectInfo* connectInfo, const char* pData, int pDataSize)
{
    
}


void NetworkManager::lobbyHandleRequestGameCancelRes(ConnectInfo* connectInfo, const char* pData, int pDataSize)
{
    
}


void NetworkManager::lobbyHandleResponseGameNoNotify(ConnectInfo* connectInfo, const char* pData, int pDataSize)
{
...
void NetworkManager::lobbyHandleGetRoomListRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::lobbyHandleCreateRoomRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
    printf("NetworkManager::lobbyHandleCreateRoomRes");
...
void NetworkManager::lobbyHandleEnterRoomRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleEnterRoomNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleReadyRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleReadyNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleUnReadyRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleUnReadyNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleChangeTribeRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleChangeTribeNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleLeaveRoomRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleLeaveRoomNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::lobbyHandleStartGameNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::lobbyHandleQuickPlayRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::gameHandleFirstConnectRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    printf("NetworkManager::gameHandleFirstConnectRes");
...
void NetworkManager::gameHandleStartGameNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    printf("NetworkManager::gameHandleStartGameNotify");
...
void NetworkManager::gameHandleClientNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::gameHandleFinishGameRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    printf("NetworkManager::gameHandleFinishGameRes");
...
void NetworkManager::gameHandleReconnectRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::chattingHandleFirstConnectRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::chattingHandleMoveLocationRes(ConnectInfo* connectInfo, const char* data, int dataSize)
{
    
}


void NetworkManager::chattingHandleSendChattingNotify(ConnectInfo* connectInfo, const char* data, int dataSize)
{
...
void NetworkManager::frontSendFirstConnectReq()
{
...
void NetworkManager::frontSendLoginReq(const char* userId, int16_t userIdLen)
{
...
void NetworkManager::frontSendCreateAccountReq(const char* userId, int16_t userIdLen, const char* nickName, int8_t nickNameLen)
{
...
void NetworkManager::frontSendEnterLobbyReq()
{
...
void NetworkManager::frontSendEnterLobbyOk()
{
...
void NetworkManager::lobbySendFirstConnectReq()
{
...
void NetworkManager::lobbySendGetChannelListReq()
{
...
void NetworkManager::lobbySendMoveChannelReq(int channelNo)
{
...
void NetworkManager::lobbySendGetUserInfoReq(const char* nickName, int8_t nickNameLen)
{
...
void NetworkManager::lobbySendRequestGameReq(const char* nickName, int8_t nickNameLen)
{
...
void NetworkManager::lobbySendRequestGameCancelReq()
{
...
void NetworkManager::lobbySendResponseGameYesReq(const char* nickName, int8_t nickNameLen)
{
...
void NetworkManager::lobbySendResponseGameNoReq(const char* nickName, int8_t nickNameLen)
{
...
void NetworkManager::lobbySendGetRoomListReq()
{
...
void NetworkManager::lobbySendCreateRoomReq(const char* roomName, int roomNameLen, int mapType)
{
...
void NetworkManager::lobbySendEnterRoomReq(int roomNo)
{
...
void NetworkManager::lobbySendReadyReq()
{
...
void NetworkManager::lobbySendUnReadyReq()
{
...
void NetworkManager::lobbySendChangeTribeReq(int tribe)
{
...
void NetworkManager::lobbySendLeaveRoomReq()
{
...
void NetworkManager::lobbySendQuickPlayReq(int tribe)
{
...
void NetworkManager::gameSendFirstConnectReq()
{
...
void NetworkManager::gameSendClientNotify(int bufferLen, const char* clientSendBuffer)
{
...
void NetworkManager::gameSendFinishGameReq()
{
...
void NetworkManager::gameSendMoveLobbyOk()
{
...
void NetworkManager::gameSendReconnectReq()
{
...
void NetworkManager::chattingSendFirstConnectReq()
{
...
void NetworkManager::chattingSendMoveLocationReq(int32_t loNo)
{
...
void NetworkManager::chattingSendSendChattingReq(const char* chatting, uint8_t chattingLen)
{
