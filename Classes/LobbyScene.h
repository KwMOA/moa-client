...
class LobbyAIGameLayer;
class LobbyRankGameLayer;
...
enum CURRENT_LAYER
{
    CURRENT_LAYER_MAIN = 0,
    CURRENT_LAYER_GAME,
    CURRENT_LAYER_AI_GAME,
    CURRENT_LAYER_RANK_GAME,
...
class LobbyScene : public BaseLayer
{
public:
...
//	ScrollView* scrollView;
    ...
    LobbyAIGameLayer* lobbyAIGameLayer;
    LobbyRankGameLayer* lobbyRankGameLayer;
